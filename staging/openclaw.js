...
// include: /tmp/tmpf_4pqco9.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/testuser/projects/.claude/worktrees/fix-offline-play/Build_Release/openclaw.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/home/testuser/projects/.claude/worktrees/fix-offline-play/Build_Release/openclaw.data');
      }
      Module['addRunDependency']('datafile_/home/testuser/projects/.claude/worktrees/fix-offline-play/Build_Release/openclaw.data');
...
// end include: /tmp/tmpf_4pqco9.js
...
var ASM_CONSTS = {
 ...
 746403: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 746486: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 746555: () => { return window.innerWidth; },  
 746585: () => { return window.innerHeight; }
};
